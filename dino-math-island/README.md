...
> 本仓库按《开发文档-恐龙数学岛.md》构建。当前进度：**Phase 0（脚手架）+ Phase 1（加减核心循环）已完成并可运行**。
...
| Phase 2 | 乘法/除法/口诀馆、题型阶梯、知识点解锁 | ⏳ 待开发 |
| Phase 3 | 掌握度模型完善、教师/家长门 + 看板（9×9 热力图等） | ⏳ 待开发 |
| Phase 4 | 动效/护眼/多档案/贴纸册/异常处理/大屏适配打磨 | ⏳ 待开发 |

> 地图上「乘法岛 / 除法岛 / 乘法口诀馆」当前显示为 🔒 Phase 2，符合「只做 Phase 0/1」的范围。
> 引擎里的乘除出题逻辑已实现，Phase 2 只需开放入口与口诀馆 UI。
